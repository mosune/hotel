		...
		$.ajax({
			...
			success:function(result) {
				...
				$(result.paging.list).each(function(i, o) {
					data.push("<tr>");
					data.push("<td>");
					data.push(o.menuName);
					data.push("</td>");
					data.push("<td>");
					data.push(o.path);
					data.push("</td>");
					data.push("<td>");
					data.push(o.menuOrder);
					data.push("</td>");
					data.push("<td>");
					if (o.pid == 1) data.push("系统管理");
					if (o.pid == 6) data.push("宾馆管理");
					if (o.pid == 10) data.push("住房管理");
					if (o.pid == 12) data.push("信息查看");
					data.push("</td>");
					data.push("</tr>");
				});
