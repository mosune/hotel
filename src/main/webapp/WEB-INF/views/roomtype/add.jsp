            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form onsubmit="return checkForm();" method="post" class="form-horizontal" action="<%=root%>/hotel/roomtype/addOrUpdate.do?flag=${flag}">
                        	<input type="hidden" name="id" value="${roomtype.id}" />
                            <div class="form-group">
                                <label class="col-sm-2 control-label"><span style="color:red">*</span>名称：</label>
                                <div class="col-sm-10">
                                    <input type="text" id="typeName" value="${roomtype.name}" name="name" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="remark" class="form-control">${roomtype.remark}</textarea>
                                </div>
                            </div>
                            <div class="hr-line-dashed"></div>
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    <a href="<%=root %>/hotel/roomtype/index.do"><button class="btn btn-white" type="button">取消</button></a>
                                </div>
                            </div>
                        </form>
                    </div>
